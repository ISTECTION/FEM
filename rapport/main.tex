...
\begin{multicols}{2}
    ...
    \begin{tikzpicture}[scale=1.3]
        ...
        \draw[very thick, blue] (A1) -- (B2);
        \draw[very thick, blue] (A2) -- (B2);
        \draw[very thick, blue] (A2) -- (B3);
        \draw[very thick, blue] (B2) -- (C1);
        \draw[very thick, blue] (B2) -- (C2);
        \draw[very thick, blue] (C1) -- (D2);
