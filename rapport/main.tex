...
\begin{multicols}{2}
    ...
    \begin{tikzpicture}[scale=1.3]
        \draw[step=1cm,lightgray,very thin] (-0.9, 3.1) grid (4.9,10.9);

        \draw[thick,->] (-0.5,4) -- (4.5, 4   ) node[anchor=north west] {x};
        \draw[thick,->] (0,3.5)  -- (0,   10.5) node[anchor=south east] {y};

        % Красные пунктирные линии
        \draw[thick, dashed, red] (1, 4  ) -- (1, 5  );
        \draw[thick, dashed, red] (4, 4  ) -- (4, 5  );
        \draw[thick, dashed, red] (0, 5  ) -- (1, 5  );
        \draw[thick, dashed, red] (0, 6  ) -- (1, 6  );
        \draw[thick, dashed, red] (0, 8.5) -- (1, 8.5);
        \draw[thick, dashed, red] (0, 10 ) -- (1, 10 );

        % Узлы
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A1) at (1,   5  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A2) at (1.5, 5  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A3) at (4,   5  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B1) at (1,   6  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B2) at (1.5, 6  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B3) at (4,   6  ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C1) at (1,   8.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C2) at (4,   8.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D1) at (1,   10 ){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D2) at (4,   10 ){};

        % Подписи узлов
        \node[below left]  at (1,   5  )    {\color{blue}$0$};
        \node[below]       at (1.5, 5  )    {\color{blue}$1$};
        \node[below right] at (4,   5  )    {\color{blue}$2$};
        \node[below left]  at (1,   6  )    {\color{blue}$3$};
        \node[below right] at (1.5, 6  )    {\color{blue}$4$};
        \node[below right] at (4,   6  )    {\color{blue}$5$};
        \node[above left]  at (1,   8.5)    {\color{blue}$6$};
        \node[above right] at (4,   8.5)    {\color{blue}$7$};
        \node[above left]  at (1,   10 )    {\color{blue}$8$};
        \node[above right] at (4,   10 )    {\color{blue}$9$};

        % Линии с подписями
        \draw[blue] (A1) -- (A3) node [midway, below, black] {$S_2^1$};
        \draw[blue] (D1) -- (D2) node [midway, above, black] {$S_2^3$};
        \draw[blue] (B1) -- (B3);
        \draw[blue] (C1) -- (C2);
        \draw[blue] (A1) -- (D1) node [midway, left, black]  {$S_2^2$};
        \draw[blue] (A3) -- (B3) node [midway, right, black] { $S_1$ };
        \draw[blue] (B3) -- (D2) node [midway, right, black] { $S_3$ };
        \draw[blue] (A1) -- (B2);
        \draw[blue] (A2) -- (B2);
        \draw[blue] (A2) -- (B3);
        \draw[blue] (B2) -- (C1);
        ...
        % Области
        \footnotesize
        \node at (1.325,5.15 )  {$\Omega_1$};
        \node at (1.2,  5.825)  {$\Omega_2$};
        \node at (2.5,  5.75 )  {$\Omega_3$};
        \node at (3.5,  5.35 )  {$\Omega_4$};
        \node at (1.2,  6.2  )  {$\Omega_5$};
        \node at (2.5,  7.5  )  {$\Omega_6$};
        \node at (3.5,  6.5  )  {$\Omega_7$};
        \node at (3.5,  9.25 )  {$\Omega_8$};
        \node at (1.5,  9.5  )  {$\Omega_9$};
        \normalsize
        % Координаты осей
        \foreach \x in {1,2,3,4}      \draw (\x cm,4cm + 1pt) -- (\x cm,4cm - 1pt) node[anchor=north] {$\x$};
        \foreach \y in {5,6,7,8,9,10} \draw (1pt,\y cm)       -- (-1pt,\y cm)      node[anchor=east]  {$\y$};
    \end{tikzpicture}
\end{multicols}
    ...
    \begin{tikzpicture}[scale=0.9]
        \begin{axis}[view={-60}{30},xlabel=$x$,ylabel=$y$]
            \addplot3[
                ...
                (1,   5,   29  )    (1.5, 5,   29.5)    (1.5, 6,   35.5)
                (1,   5,   29  )    (1,   6,   35  )    (1.5, 6,   35.5)
                (1.5, 5,   29.5)    (1.5, 6,   35.5)    (4,   6,   38  )
                (1.5, 5,   29.5)    (4,   6,   38  )    (4,   5,   32  )
                (1,   6,   35  )    (1.5, 6,   35.5)    (1,   8.5, 50  )
                (1,   8.5, 50  )    (1.5, 6,   35.5)    (4,   8.5, 53  )
                (1.5, 6,   35.5)    (4,   8.5, 53  )    (4,   6,   38  )
                (1,   8.5, 50  )    (4,   8.5, 53  )    (4,   10,  62  )
                (1,   8.5, 50  )    (1,   10,  59  )    (4,   10,  62  )
            };
        \end{axis}
    \end{tikzpicture}
\end{multicols}
...
\begin{multicols}{2}
    \setlength{\leftskip}{2.5cm}
    \noindent       \vspace{5mm}    \\
    $u(x,y)=2x+3y+1$ \vspace{2mm}   \\
    $f(x,y)=2x+3y+2$\vspace{2mm}    \\
    $\lambda=x+y$   \vspace{2mm}    \\
    $\gamma=2$      \vspace{2mm}    \\
    $\beta=5$      \vspace{2mm}     \\
    ...
    \begin{tikzpicture}[scale=1.1]
        ...
        % Красные пунктирные линии
        \draw[thick, dashed, red] (2,0) -- (2,1);
        \draw[thick, dashed, red] (3,0) -- (3,1);
        \draw[thick, dashed, red] (0,2) -- (1,2);
        \draw[thick, dashed, red] (0,3) -- (1,3);

        % Узлы
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (O) at (2.5,2.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A1) at (2,1){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A2) at (3,1){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B1) at (1,2){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B2) at (4,2){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C1) at (1,3){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C2) at (4,3){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D1) at (2,4){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D2) at (3,4){};

        % Подписи узлов
        \node[above right]         at (2.5,2.5) {\color{blue}$0$};
        \node[below left]    at (2,1)   {\color{blue}$1$};
        \node[below right]   at (3,1)   {\color{blue}$2$};
        \node[below left]    at (1,2)   {\color{blue}$3$};
        \node[below right]   at (4,2)   {\color{blue}$4$};
        \node[above left]    at (1,3)   {\color{blue}$5$};
        \node[above right]   at (4,3)   {\color{blue}$6$};
        \node[above left]    at (2,4)   {\color{blue}$7$};
        \node[above right]   at (3,4)   {\color{blue}$8$};

        % Линии с подписями
        \draw[blue] (A1) -- (A2) node [midway, below, black]        {$S_1^1$};
        \draw[blue] (A2) -- (B2) node [midway, below right, black]  {$S_2^2$};
        \draw[blue] (B2) -- (C2) node [midway, right, black]        {$S_1^3$};
        \draw[blue] (C2) -- (D2) node [midway, above right, black]  {$S_2^3$};
        \draw[blue] (D2) -- (D1) node [midway, above, black]        {$S_3$};
        \draw[blue] (D1) -- (C1) node [midway, above left, black]   {$S_2^4$};
        \draw[blue] (C1) -- (B1) node [midway, left, black]         {$S_1^2$};
        \draw[blue] (B1) -- (A1) node [midway, below left, black]   {$S_2^1$};
        ...
        % Области
        \node at (2.5,1.5)      {$\Omega_1$};
        \node at (3.25,1.75)    {$\Omega_2$};
        \node at (3.5,2.5)      {$\Omega_3$};
        \node at (3.25,3.25)    {$\Omega_4$};
        \node at (2.5,3.5)      {$\Omega_5$};
        \node at (1.75,3.25)    {$\Omega_6$};
        \node at (1.5,2.5)      {$\Omega_7$};
        \node at (1.75,1.75)    {$\Omega_8$};
...
\begin{multicols}{2}
    \setlength{\leftskip}{2.5cm}
    \noindent    \vspace{5mm} \\
    $S_1^1 = 2x+4$ \vspace{2mm} \\
    $S_1^2 = 3y+3$ \vspace{2mm} \\
    $S_1^3 = 3y+9$ \vspace{2mm} \\
    $S_2^1 = -\frac{5}{\sqrt{2}}(x+y)$ \vspace{2mm} \\
    $S_2^2 = -\frac{1}{\sqrt{2}}(x+y)$ \vspace{2mm} \\
    $S_2^3 =  \frac{5}{\sqrt{2}}(x+y)$ \vspace{2mm} \\
    $S_2^4 =  \frac{1}{\sqrt{2}}(x+y)$ \vspace{2mm} \\
    $S_3 = \frac{13x+3y}{5}+13$
    ...
    \begin{tikzpicture}[scale=0.9]
        \begin{axis}[view={-60}{30},xlabel=$x$,ylabel=$y$]
            \addplot3[
                ...
                (2.5, 2.5, 13.5)    (2, 1, 8)    (3, 1, 10)
                (2.5, 2.5, 13.5)    (3, 1, 10)   (4, 2, 15)
                (2.5, 2.5, 13.5)    (4, 2, 15)   (4, 3, 18)
                (2.5, 2.5, 13.5)    (4, 3, 18)   (3, 4, 19)
                (2.5, 2.5, 13.5)    (3, 4, 19)   (2, 4, 17)
                (2.5, 2.5, 13.5)    (2, 4, 17)   (1, 3, 12)
                (2.5, 2.5, 13.5)    (1, 3, 12)   (1, 2, 9)
                (2.5, 2.5, 13.5)    (1, 2, 9)    (2, 1, 8)
            };
        \end{axis}
    \end{tikzpicture}
\end{multicols}
...
\subsection*{Дополнительный узел внутри области (Тест №4)}
...
\begin{multicols}{2}
    ...
    \begin{tikzpicture}[scale=1.0]
        ...
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D) at (2,4){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (E) at (7,4){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (F) at (3,3){};
        ...
        % Области
        \node at (2.3,0.7)   {$\Omega_1$};
        \node at (2.7,1.25)  {$\Omega_2$};
        \node at (2.4,2.95)  {$\Omega_3$};
        \node at (3.5,3.5)   {$\Omega_4$};
        \node at (4.08,2.5)  {$\Omega_5$};
...
\begin{multicols}{2}
    ...
    \begin{tikzpicture}[scale=1.0]
        ...
        % Узлы
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (A1) at (2,0){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B1) at (2,0.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (B2) at (2.5,0.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C1) at (2,1){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C2) at (2.5,1){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (C3) at (3,1){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D1) at (2.5,2){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (D2) at (3,2){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (E1) at (2,2.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (E2) at (5,2.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (F1) at (3,3){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (G1) at (2.5,3.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (G2) at (5,3.5){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (S1) at (2,4){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (S2) at (4.5,4){};
        \node[fill=blue, circle, inner sep=1pt, minimum size=1pt] (S3) at (7,4){};

        % Подписи узлов
        \tiny
        \node[above left]  at (2,0)         {\color{blue}$0$};
        \node[left]  at (2,0.5)             {\color{blue}$1$};
        \node[below right] at (2.5,0.5)     {\color{blue}$2$};
        \node[above left]  at (2,1)         {\color{blue}$3$};
        \node[above left]  at (2.5,1)       {\color{blue}$4$};
        \node[below right] at (3,1)         {\color{blue}$5$};
        \node[left] at (2.5,2)              {\color{blue}$6$};
        \node[below right] at (3,2)         {\color{blue}$7$};
        \node[left] at (2,2.5)              {\color{blue}$8$};
        \node[below right] at (5,2.5)       {\color{blue}$9$};
        \node[left] at (3,3)                {\color{blue}$10$};
        \node[left] at (2.5,3.5)            {\color{blue}$11$};
        \node[below right] at (5,3.5)         {\color{blue}$12$};
        \node[above left] at (2,4)          {\color{blue}$13$};
        \node[above] at (4.5,4)             {\color{blue}$14$};
        \node[above right] at (7,4)         {\color{blue}$15$};
