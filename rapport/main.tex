...
\begin{multicols}{2}
    ...
    $S_2^1 = -\frac{5}{\sqrt{2}}3y$ \vspace{2mm} \\
    $S_2^2 = -\frac{1}{\sqrt{2}}3y$ \vspace{2mm} \\
    $S_2^3 =  \frac{5}{\sqrt{2}}3y$ \vspace{2mm} \\
    $S_2^4 =  \frac{1}{\sqrt{2}}3y$ \vspace{2mm} \\
    $S_3 = \frac{10x+9y}{5}+13$
